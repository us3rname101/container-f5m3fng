...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-f5m3fng.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-f5m3fng.containers.anotherwebservice.com/
...
```
git clone git@github.com:us3rname101/container-f5m3fng.git
cd container-f5m3fng
```
...
```
docker attach container-f5m3fng
```
